...
!DEC$ ATTRIBUTES DLLEXPORT :: FirstHorzTideStrain3
!DEC$ ATTRIBUTES ALIAS:'FirstHorzTideStrain3' :: FirstHorzTideStrain3
...
!DEC$ ATTRIBUTES DLLEXPORT :: SecondHorzTideStrain4
!DEC$ ATTRIBUTES ALIAS:'SecondHorzTideStrain4' :: SecondHorzTideStrain4
      IMPLICIT REAL*8(A-H,O-Z),INTEGER*4(I-N)
      DIMENSION ASTRON(12)
c
      call Ntide1(ETime,Astron)
...
!DEC$ ATTRIBUTES DLLEXPORT :: GravityTide6
!DEC$ ATTRIBUTES ALIAS:'GravityTide6' :: GravityTide6
      IMPLICIT REAL*8(A-H,O-Z),INTEGER*4(I-N)
      DIMENSION ASTRON(12)
c
      call Ntide1(ETime,Astron)
...
!DEC$ ATTRIBUTES DLLEXPORT :: TiltTide7
!DEC$ ATTRIBUTES ALIAS:'TiltTide7' :: TiltTide7
      IMPLICIT REAL*8(A-H,O-Z),INTEGER*4(I-N)
      DIMENSION ASTRON(12)
c
      call Ntide1(ETime,Astron)
...
!DEC$ ATTRIBUTES DLLEXPORT :: DryTide8
!DEC$ ATTRIBUTES ALIAS:'DryTide8' :: DryTide8
      IMPLICIT REAL*8(A-H,O-Z),INTEGER*4(I-N)
      DIMENSION ASTRON(12)
c
      call Ntide1(ETime,Astron)
...
!DEC$ ATTRIBUTES DLLEXPORT :: ShearTide9
!DEC$ ATTRIBUTES ALIAS:'ShearTide9' :: ShearTide9
      IMPLICIT REAL*8(A-H,O-Z),INTEGER*4(I-N)
      DIMENSION ASTRON(12)
c
      call Ntide1(ETime,Astron)
